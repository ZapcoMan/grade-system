<template>
  <div>
    ...
    <div style="height: 60px; display: flex;">
      ...
      <div
          style="width: fit-content; padding-right: 20px; display: flex; align-items: center; border-bottom: 1px solid #ddd">
        <el-dropdown>
      ...
      <div style="width: 240px;">
        <el-menu router :default-openeds="['1']" :default-active="router.currentRoute.value.path"
          ...
          <el-sub-menu index="2">
            ...
            <el-menu-item index="/manager/course" v-if="data.user.role === 'USER' ">课程管理</el-menu-item>
